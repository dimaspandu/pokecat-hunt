...
interface AvailableItemsModalProps {
  foodItems: (GameItem & ItemDefinition)[];
 ...
 * 
 * Displays a list of available food items to use during the catch sequence.
 * Each item includes its icon, name, description, quantity, and success rate.
 * Modal can be closed via the Cancel button.
 */
export default function AvailableItemsModal({ foodItems, onUse, onClose }: AvailableItemsModalProps) {
  return (
